  ...
  return (
    <div className="w-full h-full bg-white shadow-lg  py-8  overflow-hidden">
      <h3 className="text-center font-bold text-3xl md:text-4xl text-[#01224F] mb-4">
        Alumni <span className="text-[#FFB700]">Journey</span>
      </h3>

      <Slider {...settings}>
        {successors.map((successor) => (
          <div key={successor.id} className="px-2">
            <div className="bg-white rounded-lg shadow-lg p-4 flex flex-col items-center relative border border-[#FFB700] min-h-[320px]">
              {/* Company Logo */}
