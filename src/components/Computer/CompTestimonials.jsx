  ...
  return (
    <div className="w-full h-full bg-white shadow-lg px-4 md:px-8 mt-6 overflow-hidden">
      <h3 className="text-center font-bold text-3xl md:text-4xl text-[#01224F] mb-4">
        Alumni <span className="text-[#6095ff]">Journey</span>
      </h3>

      <Slider {...settings}>
        {successors.map((successor) => (
          <div key={successor.id} className="px-2">
            <div className="bg-white rounded-lg shadow-lg p-4 flex flex-col items-center relative border border-[#6095ff] min-h-[320px]">
              {/* Company Logo */}
