...
function MechHero() {
  ...
  return (
    <div
      className="relative pt-8 md:px-6 h-auto bg-cover bg-right md:bg-center bg-no-repeat text-white flex items-start"
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start z-20 w-full mb-4 sm:mb-6">
        ...
        <div className="mt-4  py-2 px-4 text-center lg:text-left">
          <p className="font-semibold  text-3xl md:text-5xl md:mb-5">
