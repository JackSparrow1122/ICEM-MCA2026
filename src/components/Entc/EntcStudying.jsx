    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row px-6 md:px-12 py-8 gap-10 poppins-regular overflow-hidden">
        ...
        <div className="w-full lg:w-3/5" data-aos="fade-right">
          ...
          Our students gain exposure to cutting-edge labs, industrial practices, and expert mentoring, preparing them for a successful career in the engineering field.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-6">
            {cards.map((card, index) => (
              <div
                key={index}
                className="bg-white p-4 shadow-lg shadow-[#36A5B9]/30 flex items-start rounded-lg"
                data-aos="zoom-in"
              >
      ...
      <section className="px-6 py-6 " data-aos="fade-up">
        <h2 className="text-2xl md:text-3xl font-semibold text-center text-[#36A5B9] mb-6 md:mb-8">
          ICEM Highlights
        </h2>
