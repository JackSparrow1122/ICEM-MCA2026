...
import backgroundImage from "../../assets/images/Entc-Images/entc-bg.avif";
...
>>>>>>> 1b62aa6 (push)
          ...
          <div className="hidden lg:block">
            ...
            <p className="text-2xl md:text-3xl py-2">
              <span className="text-[#36A5B9] font-bold">Transform</span> Your Future with <span className="text-[#36A5B9] font-bold">ENTC Engineering</span> at ICEM!
            </p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
          ...
          >
            <form className="space-y-3">
              ...
              <button type="submit" className="w-full py-2 bg-[#36A5B9] text-white rounded-lg hover:bg-[#005a99]">
                Submit
              </button>
            </form>
          </div>
