...
function ItStudying() {
  ...
  const cards = [
    ...
    { icon: <FaUsers className="text-[#117577] mr-4 text-4xl" />, text: '450+ INDUSTRY PARTNERS' },
    { icon: <FaBuilding className="text-[#117577] mr-4 text-4xl" />, text: 'EXPOSURE TO INDUSTRIAL GUEST LECTURES' },
